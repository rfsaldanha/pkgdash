...
stats_la <- deposit_stats(era5_daily_la[1:3], all_versions_only = TRUE, progress = FALSE)

stats_africa <- deposit_stats(era5_daily_africa[1:3], all_versions_only = TRUE, progress = FALSE)
